...
/**
 * <p>
 * An alternative to {@link org.apache.tapestry5.corelib.components.EventLink} that, given an object
...
public class PrimaryKeyEventLink {
	...
	/**
	 * Binding the zone parameter turns the link into a an Ajax control that causes the related zone
	 * to be updated.
	 */
	@Parameter(defaultPrefix = BindingConstants.LITERAL)
	@Property

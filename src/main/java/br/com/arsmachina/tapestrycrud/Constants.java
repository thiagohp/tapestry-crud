...
final public class Constants {
	 ...
	 */
	final public static String REMOVE_OBJECT_EVENT = "removeObject";

	/**
	 * Event generated by the link the resets a <code>Grid</code> sorting in a <code>BaseListPage</code>.
	 */
	final public static String RESET_SORTING_EVENT = "resetGridSorting";

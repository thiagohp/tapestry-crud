...
package net.sf.arsmachina.tapestrycrud.pages;
...
import net.sf.arsmachina.tapestrycrud.Constants;
import net.sf.arsmachina.tapestrycrud.CrudPage;
...
public abstract class BasePage<T, K extends Serializable, A extends Serializable> implements
	...
	/**
	 * @see net.sf.arsmachina.tapestrycrud.CrudPage#getMessage()
	 */
	...
	/**
	 * @see net.sf.arsmachina.tapestrycrud.CrudPage#setMessage(java.lang.String)
	 */
	...
	/**
	 * @see net.sf.arsmachina.tapestrycrud.CrudPage#getEntityClass()
	 */

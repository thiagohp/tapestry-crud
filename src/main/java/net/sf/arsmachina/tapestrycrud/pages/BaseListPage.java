...
import net.sf.arsmachina.tapestrycrud.grid.ControllerGridDataSource;
...
public abstract class BaseListPage<T, K extends Serializable, A extends Serializable> extends
	 ...
	 * 
	 * @see net.sf.arsmachina.tapestrycrud.pages.BasePage#isfilterReadOnlyComponentsInBeanModel()
	 */
	@Override
	 ...
	 * 
	 * @see net.sf.arsmachina.tapestrycrud.pages.BasePage#getBeanModel()
	 */
	@SuppressWarnings("unchecked")
	@Override
